  ...
  if (success) return (
    <div className="rb">
      <div className="rb-success">
        ...
        <button className="rb-new-btn" onClick={() => { setPhone(''); setMember(null); setSelected(null); setSuccess(false) }}>
  ...
  return (
    <div className="rb">
      <div className="rb-header">
        ...
        <p className="rb-sub">Process book returns and calculate overdue fines automatically</p>
      </div>
        ...
        <div className="rb-card">
          ...
          <form onSubmit={handleFind} className="rb-form">
            <div className="rb-input-row">
              <input className="rb-input" placeholder="Enter phone number…" value={phone} onChange={e => setPhone(e.target.value)} />
        ...
        <div className="rb-card">
          <div className="rb-member-banner">
            ...
            <div>
              ...
              <div className="rb-member-meta">{member.id} · {member.phone}</div>
            </div>
          </div>
              ...
              return (
                <div key={b.id} className="rb-book-item" onClick={() => setSelected(b)}>
                  <div>
                    ...
                    <div className="rb-book-meta">{b.acc} · Issued: {formatDate(b.issued)} · Due: {formatDate(b.due)}</div>
                  </div>
                  <div className="rb-book-right">
                    {fi.days > 0
                      ? <span className="rb-overdue-badge">{fi.days}d overdue — Rs.{fi.fine}</span>
      ...
      {member && selected && fineInfo && (
        <div className="rb-card">
          ...
          <div className="rb-confirm-grid">
            ...
            <div className="rb-row"><span>Overdue Days</span><strong style={{ color: fineInfo.days > 0 ? '#ef4444' : '#16a34a' }}>{fineInfo.days}</strong></div>
