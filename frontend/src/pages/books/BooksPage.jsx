...
export default function BooksPage() {
  ...
  const needsAttention = outOfStock + maintenance
  ...
  const filtered = books.filter(b => {
    ...
    const matchStatus = statusFilter === 'All Status' || b.status === statusFilter.replace(' ', '_')
    ...
    <div className="bp">
      ...
      <div className="bp-kpi-row">
        <div className="bp-kpi">
          ...
          <div className="bp-kpi-body">
            ...
            <div className="bp-kpi-value">{totalBooks.toLocaleString()}</div>
        ...
        <div className="bp-kpi">
          ...
          <div className="bp-kpi-body">
            ...
            <div className="bp-kpi-value bp-kpi-value--green">{availableBooks}</div>
            <div className="bp-kpi-sub">{((availableBooks / totalBooks) * 100).toFixed(1)}% of total copies on shelf</div>
          </div>
        </div>
        ...
        <div className="bp-kpi">
          ...
          <div className="bp-kpi-body">
            ...
            <div className="bp-kpi-sub">{((borrowedBooks / totalBooks) * 100).toFixed(1)}% currently on loan</div>
          </div>
        </div>
        ...
        <div className="bp-kpi bp-kpi--warn">
          ...
          <div className="bp-kpi-body">
            ...
            <div className="bp-kpi-sub">books past due date — fines accumulating</div>
          </div>
        </div>
        ...
        <div className="bp-kpi bp-kpi--maint">
          ...
          <div className="bp-kpi-body">
            ...
            <div className="bp-kpi-value bp-kpi-value--orange">{needsAttention}</div>
            <div className="bp-kpi-sub">{maintenance} in maintenance, {borrowedBooks} copies on loan</div>
          </div>
        </div>
      </div>
      ...
      <div className="bp-toolbar">
        <div className="bp-search">
          <SearchIcon />
          <input placeholder="Search by title, ISBN, author…" value={search}
      ...
      <div className="bp-card">
        <table className="bp-table">
          <thead>
            <tr>
              <th>BOOK ID</th><th>ISBN</th><th>TITLE &amp; AUTHOR</th><th>CATEGORY</th>
              <th>AVAILABLE</th><th>BORROWED</th><th>TOTAL</th><th>STATUS</th><th>ACTIONS</th>
            </tr>
          </thead>
          <tbody>
            {filtered.map(b => {
